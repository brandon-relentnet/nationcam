...
import { Film, LogIn, MapPin, Plus, Settings } from 'lucide-react'
          ...
          <div className="rounded-xl border border-overlay0 bg-surface0 p-8 shadow-xl">
            <div className="mb-6 flex flex-col items-center gap-3 text-center">
              ...
              <p className="mb-0 text-sm text-subtext0">
                Sign in to manage cameras and locations
              </p>
            </div>
            <Button
              text="Sign In"
...
function AdminDashboard() {
  ...
  const fetchData = async () => {
    ...
    // Fetch sublocations for all states
    ...
    <div className="page-container space-y-10">
      ...
      <Reveal variant="blur">
        <div className="flex items-start justify-between">
          ...
          <Button text="Sign Out" variant="ghost" size="sm" onClick={logout} />
        </div>
      </Reveal>
